...
@pytest.mark.asyncio
async def test_add_duplicate_name_entertainment_raises(entertainment_service: EntertainmentService) -> None:
    ...
    with pytest.raises(ValueError, match=re.escape("Развлечение c таким ID уже существует.")):
