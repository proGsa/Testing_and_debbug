...
async def test_add_travel_duplicate_id(travel_service: TravelService) -> None:
    ...
    accs = [Accommodation(accommodation_id=1, price=46840, address="Улица Гоголя, 12", name="Four Seasons",
            ...
            check_out=datetime(2025, 4, 5, 18, 0, 0), city=City(city_id=1, name='Москва'))]
    ents = [Entertainment(entertainment_id=1, duration="4 часа", address="Главная площадь", event_name="Концерт", event_time=datetime(2025, 4, 10, 16, 0, 0), city=City(city_id=1, name='Москва')), 
            Entertainment(entertainment_id=2, duration="3 часа", address="ул. Кузнецова, 4", event_name="Выставка", event_time=datetime(2025, 4, 5, 10, 0, 0), city=City(city_id=1, name='Москва'))]
    new_travel = Travel(
		travel_id=3,
		status="В процессе",
		users=[us],
